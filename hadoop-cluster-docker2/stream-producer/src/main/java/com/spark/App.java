...
public class App 
{   
    public static final String FedsTopic = "feds";
        ...
        FSDataInputStream inputStream = null;
         ...
         try {
            ...
            while (line != null) {
                ...
                ProducerRecord<String, String> rec = new ProducerRecord<String,String>(FedsTopic, line);
                System.out.println("Sending");
                producer.send(rec);

                System.out.println("Publish to feds");
    ...
    private static FSDataInputStream givenUsingPlainJava_whenConvertingFileToDataInputStream_thenCorrect() 
      throws IOException {
          final File initialFile = new File("./feds.csv");
          return new FSDataInputStream(new FileInputStream(initialFile));
    }
